...
deposit = int(input("enter amount here:"))
if deposit <= 0:
...
balance += deposit
while is_active:
    bet = int(input("enter a bet amount here:"))
    ...
    print("*********************************")
    print()
    print(f"Your balance is now worth: {balance - bet}€")
    ...
    bet_choice = int(input("Enter the number of a bet option shown in the chart please: "))
    ...
    if bet_choice == 1:
        ...
        if col_choice == rancol:
            balance = get_balance(18, bet, deposit)
        else:
        ...
        if rannum <= 36 and rannum > 19:
            ...
            balance = get_balance(17, bet, deposit)
        else:
            print("The number was", rannum)
            print(f"Sorry u lost {bet}€, better luck next time! :)")
            has_lost = True
        ...
        if rannum >= 1 and rannum <= 12:
            ...
            balance = get_balance(12, bet, deposit)
        else:
            print("The number was", rannum)
            print(f"Sorry u lost {bet}€, better luck next time! :)")
            has_lost = True
    ...
    if bet_choice == 10:
        ...
        if num_choice == rannum:
            balance = get_balance(1, bet, deposit)
        else:
            print("The number was", rannum)
            print(f"Sorry u lost {bet}€, better luck next time! :)")
            has_lost = True
        ...
        if rannum in choices:
            balance = get_balance(2, bet, deposit)
        else:
            print("The number was", rannum)
            print(f"Sorry u lost {bet}€, better luck next time! :)")
            has_lost = True
        ...
        if rannum in choices:
            balance = get_balance(3, bet, deposit)
        else:
            print("The number was", rannum)
            print(f"Sorry u lost {bet}€, better luck next time! :)")
            has_lost = True
        ...
        if rannum in choices:
            balance = get_balance(4, bet, deposit)
        else:
            print("The number was", rannum)
            print(f"Sorry u lost {bet}€, better luck next time! :)")
            has_lost = True
        ...
        if rannum in choices:
            balance = get_balance(6, bet, deposit)
        else:
            print("The number was", rannum)
            print(f"Sorry u lost {bet}€, better luck next time! :)")
            has_lost = True
